...
| Privacy Policy + Terms of Service, drafted and reviewed by an Australian lawyer | APP 1 requires a clearly-expressed, up-to-date privacy policy; a ToS needs Australian Consumer Law review (unfair contract terms apply to standard-form consumer contracts) | Privacy policy: **draft published 2026-09-26** at `/privacy` (Team 2's text, corrected by Team 1 to match the app; version acknowledgement and data export built), still needing an Australian lawyer's review. Terms of Service: not started |
