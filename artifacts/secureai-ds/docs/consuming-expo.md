# Consuming SecureAI Design System in Expo apps

Read `artifacts/secureai-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/secureai-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/secureai-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/secureai-ds/lib/native-theme";
import { useColors } from "@workspace/secureai-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/secureai-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/secureai-ds/components/native/badge";
import { Button } from "@workspace/secureai-ds/components/native/button";
import { Card } from "@workspace/secureai-ds/components/native/card";
```
...
Import and render
`@workspace/secureai-ds/components/native/button`, then run Expo
