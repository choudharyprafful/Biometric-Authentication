# Migrating web UI to SecureAI Design System

Read `artifacts/secureai-ds/docs/AGENTS.md` and
`artifacts/secureai-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/secureai-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/secureai-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/secureai-ds/hooks/use-toast`
