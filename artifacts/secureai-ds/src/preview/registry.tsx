...
export const DESIGN_SYSTEM = {
  title: 'SecureAI Design System',
  description:
    'Dark cyberpunk cockpit — electric-cyan on deep navy, zero-radius sharp corners, JetBrains Mono for technical labels.',
} as const;

export const OVERVIEW_ENTRY: PreviewEntry = {
  id: 'overview',
  name: 'Overview',
  description: 'The visual foundations and principles that shape the SecureAI cockpit aesthetic.',
  Page: OverviewPage,
};
    ...
    entries: [
      {
        id: 'brand-logo',
        name: 'Logo & mark',
        description: 'The SecureAI shield mark, usage rules, and wordmark pairing.',
        Page: BrandLogoDemo,
      },
    ],
  },
