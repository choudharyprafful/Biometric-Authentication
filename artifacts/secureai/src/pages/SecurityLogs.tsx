...
const EVENT_TYPES = [
  ...
  'DEVICE_LINK_CODE_CREATED', 'DEVICE_LINK_REDEEMED', 'LOGOUT', 'LOGOUT_ALL', 'REGISTER',
  'FACE_ENROLLED', 'FACE_REMOVED', 'PASSWORD_RESET_REQUESTED', 'PASSWORD_RESET_FACE_FAILED',
  'PASSWORD_RESET_PASSKEY_FAILED', 'PASSWORD_RESET_COMPLETED', 'USER_DELETED', 'USER_UPDATED',
  'MFA_RESET_BY_STAFF', 'PAYMENT_CREATED', 'PAYMENT_FAILED', 'SUBSCRIPTION_CHANGED',
  'PAYMENT_WEBHOOK_RECEIVED', 'PAYMENT_WEBHOOK_REJECTED', 'UPLOAD_CREATED', 'UPLOAD_DOWNLOADED',
  'UPLOAD_DELETED', 'UPLOAD_SCAN_REJECTED', 'UPLOAD_SCAN_UNAVAILABLE', 'UNAUTHORIZED_ACCESS',
  'RATE_LIMIT_HIT', 'AUDIT_LOG_CHAIN_REPAIRED', 'AUDIT_LOG_CHAIN_RESTORED',
  'MINOR_REGISTRATION_PENDING_CONSENT', 'PARENT_CONSENT_GRANTED', 'TRAINING_CONSENT_GIVEN',
  'TRAINING_CONSENT_WITHDRAWN', 'BEHAVIOR_MODEL_QUERIED', 'SECURITY_ALERT_NOTIFIED',
  'LOGIN_RISK_FLAGGED', 'CONTENT_PERSONALIZATION_CONSENT_GIVEN',
  'CONTENT_PERSONALIZATION_CONSENT_WITHDRAWN', 'CONTENT_PROFILE_QUERIED', 'PAYMENT_REFUNDED',
  'PAYMENT_IDEMPOTENT_REPLAY', 'TRAINING_SOURCE_REJECTED', 'AI_SYSTEM_TOGGLED',
  'AI_DECISION_CHALLENGED', 'AI_CHALLENGE_RESOLVED', 'PAYMENT_DISPUTED', 'PAYMENT_DISPUTE_WON',
  'PAYMENT_CHARGED_BACK', 'PAYMENT_HOLD_PLACED', 'PAYMENT_HOLD_CLEARED', 'PAYMENT_WEBHOOK_IGNORED',
