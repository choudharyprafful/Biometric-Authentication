...
import { Shield, LayoutDashboard, Users, Activity, AlertTriangle, CreditCard, Lock, ShieldCheck, BrainCircuit, Bot, Eye, Settings, LogOut, Menu, X, FileText } from 'lucide-react';
